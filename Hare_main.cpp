...
#include <string>
#include "Hare.hpp"
//g++ -std=c++11 main.cpp would be fine with #include "Hare.cpp" //#include <vector> //included in "Hare.hpp" already
using namespace std;
int main(int argc, const char *argv[]) { //does not take input from users
    ...
    case ’E’: //int getPosition();
        cout << "After setting hare’s position to be 10 and calling getPosition method, data member position is "; hare.position = 10;
